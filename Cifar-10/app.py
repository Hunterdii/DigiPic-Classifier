...
# # lottie_url = "https://lottie.host/de06d967-8825-499e-aa8c-a88dd15e1a08/dH2OtlPb3c.json"  # Replace with your Lottie URL
...
# st.markdown("<h3 style='color: #2ecc71;'>✨ Features:</h3>", unsafe_allow_html=True)

# # Using a different CSS approach for hover effect
# st.markdown("""
#     <style>
#         .feature-hover {
#             position: relative;
...
#                 <span class="tooltip-text">Get predictions in seconds.</span>
#             </div>
#         </li>
#         <li>
...
#         </li>
#         <li>
#             <div class="feature-hover">Cool Animations
#                 <span class="tooltip-text">Enjoy a sleek and modern design.</span>
#             </div>
#         </li>
#     </ul>
...
# @st.cache_resource
# def load_my_model():
#     model = tf.keras.models.load_model("streamlit-app-images-classificator-master/final_model.h5")
#     return model
...
# st.markdown(""" 
# ### **CIFAR-10 Classes**:
# Hover over each class for descriptions.
...
@st.cache_resource
def load_my_model():
    model = tf.keras.models.load_model("streamlit-app-images-classificator-master/final_model1.h5")
    return model
